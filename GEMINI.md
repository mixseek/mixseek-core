...
pytest tests/agents/test_gemini_agent_client.py
...
- **Article 15 - Naming Convention**: Use `<number>-mixseek-core-<name>` format
  ...
  - Example: `002-mixseek-core-config`, `003-mixseek-core-auth`
...
**IMPORTANT**: Follow the documentation guidelines defined in `.gemini/sphinx.md`.
...
For detailed guidelines and common pitfalls, see `.gemini/sphinx.md`.
